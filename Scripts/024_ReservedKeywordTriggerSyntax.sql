/*
    Phase 37 — T-SQL reserved keyword syntax hardening ([Trigger] column)
    Run: sqlcmd -S .\SQLEXPRESS -E -d PointOfSale -i Scripts\024_ReservedKeywordTriggerSyntax.sql
*/
SET NOCOUNT ON;
SET XACT_ABORT ON;
GO
...
PRINT N'Phase 37 Scripts\024_ReservedKeywordTriggerSyntax.sql applied.';
GO
